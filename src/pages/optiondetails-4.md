...
特殊对话：:c[10:雪莉]（敌人总数少于10个且敌方首领的第一段对话发生后）、敌方首领:c[143:基鲁萨]（有四段，血量低于80%后，:c[10:雪莉]的对话发生后，:c[57:奥兹玛]在场且敌人总数少于7个后有两段）。
...
在:c[13:迪妮芙]商店中累计购入9种:t[:晶球]各一个后（:t[:晶球]:t[:拍卖]对应的龙后可以买到），离开商店时支线剧情发生。如果在剧情发生前在:c[13:迪妮芙]商店中强化过3次:t[:遗物]，之后:c[13:迪妮芙]成为同伴时会是专属职业（作为客座角色时职业固定为女术士）。

龙可以在战场上使用技能“调教·龙系”招降获得，大部分龙系单位都会掉落特殊素材，可以借助[掉落表](./drops)查询它们的出现场所，除多头龙外的8种属性龙可以通过对应的转职证相互转换。
:t[:遗物]的强化功能首次开启:p[1:死者宫殿]Ｂ３的隐藏门并过关后解锁，初期主要从:p[1:死者宫殿]中获取。
...
做出※标记的选择:c[3:卡秋娅]之后会成为同伴，否则:c[3:卡秋娅]死亡。
